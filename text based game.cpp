...
void questreport(){
  ...
  cout<<"Before we continue, I must warn you, death awaits all who choose to fight, but we believe that there will be a light of hope at the end of the tunnel that would deem us victorius= in our pursuit for glory and freedom."<<endl;
}
